...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        UILabel *titleLab = [[UILabel alloc] initWithFrame:CGRectMake(15, 10, WIDTH-30, 15)];
        titleLab.text = @"人气新品";
...
- (UICollectionView *)productsCollectionView {
    if (!_productsCollectionView) {
        ...
        _productsCollectionView = [[UICollectionView alloc] initWithFrame:CGRectMake(0, 40, WIDTH, WIDTH/2.5 + 60) collectionViewLayout:flowLayout];
...
- (UICollectionViewCell *)collectionView:(UICollectionView *)collectionView cellForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    UIImageView *imageView = [[UIImageView alloc] initWithFrame:CGRectMake(0, 0, WIDTH/2.5, WIDTH/2.5)];
...
//    imageView.backgroundColor = PageColor;
    ...
    UILabel *titleLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, imageView.maxY+15, WIDTH/2.5, 20)];
    ...
    UILabel *priceLabel = [[UILabel alloc] initWithFrame:CGRectMake(0, titleLabel.maxY+5, WIDTH/2.5, 20)];
...
{
    return CGSizeMake(WIDTH/2.5, WIDTH/2.5 + 60);
}
