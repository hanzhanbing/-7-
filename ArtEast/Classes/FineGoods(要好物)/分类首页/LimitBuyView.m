...
- (instancetype)initWithFrame:(CGRect)frame
{
    ...
    if (self) {
        ...
        _titleLab = [[UILabel alloc] initWithFrame:CGRectMake(15, 20, WIDTH/2-30, 15)];
        _titleLab.numberOfLines = 0;
        _titleLab.font = [UIFont systemFontOfSize:14];
        [self addSubview:_titleLab];
        
        _flagLab = [[UILabel alloc] initWithFrame:CGRectMake(15, _titleLab.maxY+10, _titleLab.width, 15)];
        ...
        _imageView = [[UIImageView alloc] initWithFrame:CGRectMake(WIDTH-(self.height-30)-15, 15, self.height-30, self.height-30)];
...
- (void)setLimitDic:(NSMutableDictionary *)limitDic {
    ...
    _priceLab.frame = CGRectMake(12, self.height-32, [Utils getTextWidth:_priceLab.text fontSize:14 forHeight:15], 15);
