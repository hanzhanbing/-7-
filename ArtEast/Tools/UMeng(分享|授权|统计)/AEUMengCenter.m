...
+ (void)registerUMeng {
    ...
    //设置友盟appkey
    [[UMSocialManager defaultManager] setUmSocialAppkey:@"590bdb7e07fe6570e00012d5"];
    
    //设置微信的appId和appKey
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_WechatSession appKey:@"wxe9641f69466ea76f" appSecret:@"49d1ed691aa10465037793d68e711a9d" redirectURL:@"http://60.205.180.199"];
    
    //设置分享到QQ互联的appId和appKey
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_QQ appKey:@"1106068925"  appSecret:@"4VRbFUARGknGYQcP" redirectURL:@"http://www.cydf.com"];
    
    //设置新浪的appId和appKey
    [[UMSocialManager defaultManager] setPlaform:UMSocialPlatformType_Sina appKey:@"842398812"  appSecret:@"60f16f655f5ac34b7c8f860f378a5f9f" redirectURL:@"http://sns.whalecloud.com/sina2/callback"];
    
    
    //初始化友盟统计
    UMConfigInstance.appKey = @"590bdb7e07fe6570e00012d5";
